...
const UNAUTHORIZED = { status: HTTP_CODES.UNAUTHORIZED, code: HTTP_CODES.UNAUTHORIZED };
...
export default {
	...
	MISSING_ID_TOKEN: { message: missingValue('Firebase ID Token'), ...BAD_REQUEST, code: 1010 },
	FIREBASE_AUTH_ERROR: { message: 'Firebase authentication failed.', ...UNAUTHORIZED, code: 1009 }
};
